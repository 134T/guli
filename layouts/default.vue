<template>
  <div class="in-wrap">
    <!-- 公共头引入 -->
    <header id="header">
      <section class="container" style="min-height: 5vh">
        <h1 id="logo">
          <a href="#" title="谷粒学院">
...
export default {
  ...
  methods: {
    showInfo() {
      ...
      //debugger
      this.loginInfo.id = cookie.get('id')
      this.loginInfo.avatar = cookie.get('avatar')
      this.loginInfo.nickname = cookie.get('nickname')
