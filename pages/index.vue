<template>
  ...
  <div >
    ...
    <!-- 幻灯片 结束 -->
        ...
        <h2  style="margin-top: 20px;margin-bottom: 10px;font-family: Helvetica Neue,微软雅黑,SimHei,Tohoma;word-break: break-all;word-wrap: break-word; text-align :center">
                热门课程
        </h2>
      <div id="aCoursesList" >
      <!-- 网校课程 开始 -->
