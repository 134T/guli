  ...
  <div class="main">
    ...
    <div class="sign-up-container">
      <el-form ref="userForm" :model="params">
        ...
        <el-form-item class="input-prepend restyle no-radius" prop="mobile" :rules="[{ required: true, message: '请输入邮箱地址', trigger: 'blur' },{validator: checkPhone, trigger: 'blur'}]">
          <div>
            <el-input type="text" placeholder="邮箱地址" v-model="params.mobile"/>
  ...
  export default {
    ...
    methods: {
      getCodeFun() {
        ...
        //   return;
        if (this.sending){
          // console.log("this.sending===="+ this.sending)
          registerApi.getMobile(this.params.mobile).then(res => {
            // console.log("res======"+res.data.data.success)
