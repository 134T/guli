  ...
  <div class="app-container">
    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程简介">
        <TinymceEditor :height="300" v-model="courseInfo.description"/>
      </el-form-item>
      <!-- <TinymceEditor v-model="courseInfo.description"/> -->
      <!-- 课程封面 TODO -->
      <!-- 课程封面-->
      <el-form-item label="课程封面">
        <el-upload
          ...
          <img :src="courseInfo.cover?courseInfo.cover:'http://ww4.sinaimg.cn/large/610dc034jw1faoucp1idej20u011h0va.jpg'" style="width:160px; height:120px">
        </el-upload>
